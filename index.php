...
<html>
	...
	<table align="center">
		...
		<tr>
			...
			<?php echo '<td id="' . $class["classid"] . '-1" style="background-color:#5F5959; text-align:center;" onclick="updateStickers(' . $_SESSION["id"] . ',' . $class["classid"] . ',1)">';
			if (strpos($class["blackstickers"],$_SESSION["id"]	) !== false) {
				//true
				echo "✓";
			}
			echo '</td>'; ?>
			<?php echo '<td id="' . $class["classid"] . '-2" style="background-color:#A69E9E; text-align:center;" onclick="updateStickers(' . $_SESSION["id"] . ',' . $class["classid"] . ',2)">';
			if (strpos($class["greystickers"],$_SESSION["id"]	) !== false) {
				//true
				echo "✓";
			}
			echo '</td>'; ?>
			<?php echo '<td id="' . $class["classid"] . '-3" style="background-color:#FFFFFF; text-align:center;" onclick="updateStickers(' . $_SESSION["id"] . ',' . $class["classid"] . ',3)">';
